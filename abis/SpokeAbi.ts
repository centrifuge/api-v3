export const SpokeAbi = [
  ...
  { inputs: [], name: "InvalidRequestManager", type: "error" },
  ...
  { inputs: [], name: "MoreThanZeroLinkedVaults", type: "error" },
  ...
  { inputs: [], name: "RequestManagerNotSet", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint128", name: "remoteExtraGasLimit", type: "uint128" },
    ],
